...
const PreviewDialogBtn: React.FC<Props> = props => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className='w-screen h-screen max-h-screen max-w-full flex flex-col flex-grow p-0 gap-0'>
        ...
        <div
          className='bg-accent flex flex-col flex-grow items-center justify-center p-4 bg-[url(/graphpattern.svg)] dark:bg-[url(/graphpattern.svg)]  overflow-y-auto'>
          <div
